...
| -jwt-secret                 | string      | "random key" | X     | Secret used to sign the JWT token (if you don't use default, set related secret in http.jwt) (you can't use default and a custom one in the same caddyfile) |
